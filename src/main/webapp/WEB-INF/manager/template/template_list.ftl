<@ms.html5>
	...
	<@ms.panel>
		<@ms.uploadFile path="templets/${websiteId}/" inputName="websiteStyle" size="10" filetype="" msg="建议上传30M以下的zip文件,模版名称不能使用中文,zip的压缩方式为:存储"  maxSize="30" callBack="setUrl" isRename="false"/>
